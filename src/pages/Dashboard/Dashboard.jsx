...
import { addUser, dashboardData, sendEmail } from "../../services/service";
  ...
  return (
    <div className="p-5 px-12 bg-color1 min-h-[100vh]">
      <div className="flex justify-end">
        <button
          className="bg-pink-600 px-3 hover:bg-pink-900 rounded-lg text-white py-2 mr-4"
...
export const AddUser = ({ setToggleAddUser, setUserAdded, userAdded }) => {
